...
autobahn: clean bin/reporter
	./autobahn/script/test.sh --build --follow-logs fuzzingclient autobahn/config/client_tests.json examples/websocket/server_autobahn -o server.test --follow-logs
